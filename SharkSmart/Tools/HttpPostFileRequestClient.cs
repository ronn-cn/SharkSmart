...
namespace SharkSmart
{
    ...
    {
        public static string SendFileToService(string address, string path)
        {
            HttpPostFileRequestClient httpPost = new HttpPostFileRequestClient();
            httpPost.SetField("userSubmit", "");
            FileStream fs = new FileStream(path, FileMode.Open, FileAccess.Read);
            httpPost.SetField("userUpFile", path, "application/octet-stream", fs);
            HttpWebResponse webRespon = httpPost.Post(address);
        ...
        public static string SendFileToService(string address, string[] paths)
        {
            HttpPostFileRequestClient httpPost = new HttpPostFileRequestClient();
            httpPost.SetField("userSubmit", "");
            ...
            {
                fs = new FileStream(paths[i], FileMode.Open, FileAccess.Read);
                httpPost.SetField("userUpFile", paths[i], "application/octet-stream", fs);
                webRespon = httpPost.Post(address);
