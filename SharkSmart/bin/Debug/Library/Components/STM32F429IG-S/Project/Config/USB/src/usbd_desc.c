...
#define USBD_PRODUCT_FS_STRING        "USB FS STM32F4 APP"
...
uint8_t *  USBD_USR_SerialStrDescriptor( uint8_t speed , uint16_t *length)
{
    ...
    uint8_t stm32_id_str[40] = {0};
    
    memcpy(stm32_id, (uint8_t *)0x1FFF7A10, 12);
    
    sprintf((char *)stm32_id_str, "%02X%02X%02X%02X%02X%02X", stm32_id[0], stm32_id[1], stm32_id[2], stm32_id[3], stm32_id[4], stm32_id[5]);
    sprintf((char *)stm32_id_str + 12, "%02X%02X%02X%02X%02X%02X", stm32_id[6], stm32_id[7], stm32_id[8], stm32_id[9], stm32_id[10], stm32_id[11]);
      
    USBD_GetString (stm32_id_str, USBD_StrDesc, length);  
