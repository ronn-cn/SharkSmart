...
//线程优先级
#define TCPIP_THREAD_PRIO		TCPIP_THREAD_PRIO_NUM	//定义内核任务的优先级为5
...
#define MEM_SIZE                128*1024 	//内存堆heap大小
...
#define PBUF_POOL_BUFSIZE       2048		//PBUF_POOL_BUFSIZE:每个pbuf内存池大小
...
//有关系统的选项
#define TCPIP_THREAD_STACKSIZE          8000	//内核任务堆栈大小
